...
<%-- 							${empty detail.realfilename == true? "": detail.realfilename} --%>
			...
			<div id="newWrite_button_div">
				...
				<input type="button" value="삭제" onclick="return clickDelBtn('${detail.systemfilename }');" id="delbtn" class="btn btn btn-primary">
<%-- 				<input type="button" value="삭제" onclick="alert('${detail.systemfilename }');" id="delbtn" class="btn btn btn-primary"> --%>
